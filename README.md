...
This repository is an index for my 42 Gyeongsan projects and study archives.
...
Each project is kept in a separate repository so that the source code, README,
build files, and commit history stay focused on one assignment. This index
repository works as a portfolio entry point.
